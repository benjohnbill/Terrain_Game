...
| 07 | ✅ | ✅ **all three cleared 2026-07-31.** Battle-site reachability: ADR 0046 + TC-⑮, implementation LANDED by 06e (`b591f4e`), 27/56 → 56/56. Capital guard magnitude (Part 2 #10): **CP-⑤** rules 가안 2,500/pop — the row's "350 vs 1500" framing was wrong, `capitalGarrison 1500` was never a seal, and the live question was the coefficient's size. CP-① staleness: stamped, and it was **items 1 and 3**, not item 3 alone — R3 retired item 1's designation rule and § 1.8 misfiled it | **ready-for-agent** (blocked by 06d) |
