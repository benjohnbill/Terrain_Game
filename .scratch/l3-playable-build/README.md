...
| 06a | ✅ | ✅ **gate C closed Part 2 #14** (R12–R15, ADR 0043) and the **Part 3 batch is approved and landed 2026-07-26** — speed 3 at `war-model-build/MAGNITUDE.md` **WB-M②** (L2, measured during gate C), forced-march premium 3.0 + 2-hex cap at **WB-M①**, terrain cost uniform 1.0 by R15. Zero unlanded values, recomputed at approval time | **ready-for-agent** |
