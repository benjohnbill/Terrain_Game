...
| 07 | ✅ | ❌ capital guard magnitude (Part 2 #10); CP-① item 3 stale (§ 1.8). **The battle-site reachability blocker registered 2026-07-28 is RESOLVED 2026-07-31** (ADR 0046 + TC-⑮ — battle-capable sectors 27/56 → 56/56; implementation LANDED by 06e, `b591f4e`). The two items above are untouched | needs-info |
