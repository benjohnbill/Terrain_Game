...
> lives. Last regenerated: 2026-07-23 (L3 Wayfinder gate 07 seal batch —
> **no new Tier-1 terms**; see the gate-07 addendum below. Prior full
> regen 2026-07-14, war-model-build slice-2. Includes this session's own
> seals; per the amended law, "may lag canon" covers only content older
