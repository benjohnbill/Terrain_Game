...
> lives. Last regenerated: 2026-07-07 night (terrain-cradle birthplace
> docs created — TC rows below now point there; no definitions changed).
...
never definitions. Late-session additions (void ontology TC-⑧, great
range/하서회랑/대환 TC-⑨, 태산 TC-⑩, grid-form freeze TC-⑪, carve
principle TC-⑫) live in the birthplace only.
