...
> lives. Last regenerated: 2026-07-11 (occupation-geography stage-①
> doc-sync batch; targeted through this date — convenience surface; per
> the amended law, "may lag canon" covers only content older than the
> current session).
...
> record** (the coupling re-erects the denied-dominant wall; the fgM9on
> reserve arm absorbs it — future dominance-gate-grill evidence). Interior
...
| capLandFrac (땅-상한 결합 다이얼) | land–ceiling coupling blend; **sealed value 0 = world of record** (coupling not adopted — re-erects the wall) | MA OG-⑤ |
