...
> lives. Last regenerated: 2026-07-12 (rebellion-body &
> peacetime-institutions pass — includes this session's own seals;
> targeted through this date — convenience surface; per the amended
> law, "may lag canon" covers only content older than the current
> session).
