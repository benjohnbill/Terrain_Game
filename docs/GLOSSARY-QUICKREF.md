...
> lives. Last regenerated: 2026-07-07 (economy-flows digest + C-loop
> translation table added; no definitions changed).
>
...
Birthplace pending (terrain-cradle feature docs); rows here are
pointers for user audit, not definitions.
...
| L2 watch flags (2026-07-07, user-agreed) | ① 중원 crown needles ×2 ② develop-greedy opening ③ 강남 quiet winner (two river shields + full projection) ④ 촉-seat overperformance (nerf deferred — door dial if needed, not econ) ⑤ region-abandonment meta ⑥ 동남해 fertility funding (parked with fiction band) | L2 tournament adapter |
