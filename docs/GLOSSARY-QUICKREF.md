...
> lives. Last regenerated: 2026-07-11 (affordability & M9-promotion
> doc-sync batch — includes this session's own seals; targeted through
> this date — convenience surface; per the amended law, "may lag canon"
...
| Sudden-death crisis ending (위기 종결) — UNSEALED design | turn-32 end = rule-driven, preparable, escalating crisis (~3 turns); scorecard = last-resort fallback; 5 gates + 3 riders bind the design pass | MA AB-③ / ADR 0034 |
