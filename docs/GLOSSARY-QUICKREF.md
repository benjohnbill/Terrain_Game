...
> lives. Last regenerated: 2026-07-07 evening (L2 sheet-15 session:
> deterrence equilibrium + opportunism read registered to match-arc
> GLOSSARY; C-loop row for the frozen-world finding & impact-first
> session reorder; blinds row gloss updated).
